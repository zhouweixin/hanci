...
@author: zhouweixin
@note: 改进版3：用CNN-LSTM提取特征
"""

import torch
from torch import nn
from model.language import WordEmbedding, ReviewCNNLSTM
from model.attention import Attention
from util import utils


class NARRE_CNN_LSTM(nn.Module):
    """
    ...
    def __init__(self, train_dset, word_embedding_size=300, id_embedding_size=32,
                 ...
                 attention_size=32, num_latent=32, dropout=0.5):
        super(NARRE_CNN_LSTM, self).__init__()
        ...
        self.user_review_emb = ReviewCNNLSTM(embedding_size=word_embedding_size,
        ...
        self.item_review_emb = ReviewCNNLSTM(embedding_size=word_embedding_size,
                                             filter_sizes=filter_sizes, num_filters=num_filters,
                                             hidden_size=hidden_size, num_layers=num_layers, bidirectional=bidirectional)
    ...
    def forward(self, user_id, item_id, user_reviews, item_reviews, user_rids, item_rids, rating, norm_lambda=0.001, save_att=False):
        ...
        # 2.review_embedding
        user_reviews_emb = self.user_review_emb(user_word_emb)  # [batch, user_review_num, review_hidden_layers]
        item_reviews_emb = self.item_review_emb(item_word_emb)  # [batch, item_review_num, review_hidden_layers]
